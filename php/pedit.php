...
<body>
    ...
    <div class="header">
        ...
        <ul class="menu">
            ...
            <li class="menu"><a class="navigation" href="http://locost:8081/Air_line/phalhp/pview.php">My Booking</a>
            </li>
        ...
        <div class="row_booking">
            <div class="col_booking">
                <div class="card_booking">
                    ...
                    <div class="card_body">
                        <form method="POST" action="pupdate.php?ID=<?php echo $UserID ?>">
                            ...
                            From
                            <select name="from" class="form_layers_booking" required value="<?php echo $UserFrom ?>">
                            ...
                            To
                            <select name="to" class="form_layers_booking" required value="<?php echo $UserTo ?>">
                            ...
                            <input type="date" name="date1" class="form_layers_booking" required
                                value="<?php echo $UserDate1 ?>">
                            Return
                            <input type="date" name="date2" class="form_layers_booking"
                                value="<?php echo $UserDate2 ?>">
                            Class
                            <select name="class" class="form_layers_booking" value="<?php echo $UserClass ?>">
                                <option value="Business Class">Business class</option>
                                <option value="Economy Class">Economy class</option>
                            </select><br>

                            Adults
                            <select name="adults" class="select_layers_booking" value="<?php echo $UserAdults ?>">
                            ...
                            Children
                            <select name="children" class="select_layers_booking" value="<?php echo $UserChildren ?>">
                                <option>--select--</option>
                            ...
                            Infants
                            <select name="infants" class="select_layers_booking" value="<?php echo $UserInfants ?>">
                                <option>--select--</option>
                                <option value="none">none</option>
                                <option value="1">1</option>
                            </select>
                    ...
                    <div class="card_footer">
                        <button class="button_booking" name="update"> Update </button>
                    </div>
                    </form>
